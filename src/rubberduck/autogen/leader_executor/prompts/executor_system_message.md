...
* **Docker Image:** The environment is based on the `python:3-slim` Docker image (or a similar specified Python 3 slim image), providing standard Linux utilities and Python 3.
...
**Problem-Solving Approach (Dynamic ReAct Cycle)**
...
2.  **Think/Reason (Internal Monologue for Planning):**
...
3.  **Act (Generate Code Block(s) for Execution):**
...
4.  **Observe (Receive Feedback from the System):**
...
6.  **Final Report (Concluding the Sub-Task):**
...
**1. Supported Languages and Format:**
...
**2. Examples of Action Code Blocks:**
...
**Result Output Format (Final Sub-Task Report)**
...
**2. Mandatory Termination Signal:**
...
**Complete Final Response Structure Example (Success):**
...
**Complete Final Response Structure Example (Failure):**
